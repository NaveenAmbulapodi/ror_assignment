...
class EmployeeRolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_role" do
    assert_difference('EmployeeRole.count') do
      post employee_roles_url, params: { employee_role: { name: @employee_role.name, role_id: @employee_role.role_id } }
    end
  ...
  test "should update employee_role" do
    patch employee_role_url(@employee_role), params: { employee_role: { name: @employee_role.name, role_id: @employee_role.role_id } }
